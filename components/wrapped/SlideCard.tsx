  ...
  function SlideCard({ accentColor, className = "", sizeStyle, children }, ref) {
    return (
      <div
        ...
        className={`relative flex flex-col overflow-hidden rounded-3xl [&::-webkit-scrollbar]:hidden mx-auto w-[min(380px,95vw)] h-[calc(100dvh-280px)] lg:w-[min(380px,92vw)] lg:h-[min(580px,84vh)] ${className}`}
        style={{
